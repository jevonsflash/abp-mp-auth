...
{
    public abstract class MiniProgramWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MiniProgramWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MiniProgramWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MiniProgramDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MiniProgramDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MiniProgramDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MiniProgramDbContext, Task<T>> func)
        {
            T result;
