...
namespace WeChat.MiniProgram.Controllers
{
    ...
    public class TokenAuthController : MiniProgramControllerBase
    {
        ...
        {
            return await this._ExternalAuthenticate(model);
        }
        private async Task<ExternalAuthenticateResultModel> _ExternalAuthenticate(ExternalAuthenticateModel model)
        {
